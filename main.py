...
class Agent:
    ...
    def __init__(self, avatar_for_agent, model, tokenizer):
                    ...
                    for i in range(self.iterations - 1):
                        ...
                        for response in new_responses:
                            ...
                            if len(" ".join(summary)) > 32000:
                                summary = summary[self.get_group_number():]  # clean the summary if its size is larger than the model's context window
